...
#
# Convert event PNGs from the asset library into DDS textures inside the
# mod. Walks ~/Pictures/common-people-mod-images/ for files named
# *.dds.png and produces siblings at mod/gfx/event_pictures/<name>.dds.
#
...
#   CP_IMAGES_SRC   source PNG root     (default: ~/Pictures/common-people-mod-images)
#   CP_IMAGES_DST   destination root    (default: mod/gfx/event_pictures)

set -euo pipefail

src_root="${CP_IMAGES_SRC:-$HOME/Pictures/common-people-mod-images}"
